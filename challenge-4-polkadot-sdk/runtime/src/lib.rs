...
use polkadot_sdk::sp_runtime::{traits::{ConvertInto, IdentifyAccount, Verify}, MultiSignature};
...
mod runtime {
	...
	pub type NativePools = pallet_native_pools::Pallet<Runtime>;
}
...
parameter_types! {
    ...
    pub const MinVestedTransfer: u32 = 100;
}
